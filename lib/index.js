...
engine.generateReport = function (dataDriver, startDate, endDate, filter, callback) {
    // Flip methods around if using <= 0.0.2
    ...
    dataDriver.getData(startDate, endDate, filter, function (err, data) {
        var result = [];
